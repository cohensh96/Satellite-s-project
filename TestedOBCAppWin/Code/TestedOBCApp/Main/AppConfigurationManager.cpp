...
void AppConfigurationManager::Init(const std::string& filename)
{
    ...
    //Get the values
    //CommChannelType
    stringValue = reader.Get("General", "CommChannelType", "Tcp"); // LocalSimulation //////////
    ...
    m_destIpAddress = reader.Get("General", "DestIpAddress", AppConfiguration::DEST_ADDRESS);
...
void AppConfigurationManager::setDefaults()
{
    ...
    m_destIpAddress = AppConfiguration::DEST_ADDRESS;
