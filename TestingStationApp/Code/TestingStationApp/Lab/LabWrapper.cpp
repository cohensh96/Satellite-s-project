...
namespace LabWrap {
    ...
    extern "C" {
        ...
        __declspec(dllexport) int Lab_CreateTestsFromCatalog(Lab* lab, UserTestData userData)
        {
            TestInfo testInfo;
            strncpy_s(testInfo.recipe.testName, userData.testName, MAX_TEST_NAME_SIZE);
            testInfo.recipe.catchPolynomialDegree = userData.catchPolynomialDegree;
            ...
            strncpy_s(testInfo.firstElemData, userData.orbitingElementData1, 262);
            strncpy_s(testInfo.secondElemData, userData.orbitingElementData2, 262);
            CatalogTestFormat catalogTestFormat = userData.catalogTestFormat;
            

            return lab->CreateTestsFromCatalog(testInfo, catalogTestFormat);
        }
        ...
        //__declspec(dllexport) int Lab_CreateTestsFromCatalog(const char* catalogPath, int testType)
        //{
        //    // ���� ���� �-DLL ������ ����� ������ ��� C#
        //    // ����� �������� ������� ������ Lab
        //    return Lab::GetInstance().CreateTestsFromCatalog(std::string(catalogPath), testType);
        //}
    }
}
