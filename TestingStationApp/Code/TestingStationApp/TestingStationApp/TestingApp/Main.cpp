...
int main()
{
    ...
    // Loop to test connection until success
    std::cout << "Trying to establish connection..." << std::endl;
    while (!lab.CheckConnection()) {
    ...
    STARLINK5447_UNICORN2N
        ...
        */
        ...
        //--------------Running Tests list from catalog file---------//
        //** go to Lab.cpp -> CreateTestsFromCatalog function and remove the documantation in the line -> std::string catalogFullPathStr = "C:\\ProjectMainCopy2\\Code\\TestingStationApp\\BlazorApp1\\BlazorApp1\\FullCatalogs\\activeCatalog.txt";
        ...
        //printTestInfo(info);
        //Run the tests 
        //lab.CreateTestsFromCatalog(info, CatalogTestFormat::OneWithAll);
