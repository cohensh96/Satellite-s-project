...
public class LabInterop
{
    ...
    //[DllImport("LabWrapper.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    //public static extern int Lab_CreateTestsFromCatalog(string catalogPath, int testType);

    [DllImport("TestingStationApp.dll", CallingConvention = CallingConvention.Cdecl)]
    public static extern int Lab_CreateTestsFromCatalog(IntPtr lab, UserTestData testData);
